...
from .views import RequestRegisterationAPI, VerifyRegisterationAPI, RequestPasswordResetAPI, VerifyPasswordResetAPI, CustomTokenObtainPairView, CustomTokenRefreshView
